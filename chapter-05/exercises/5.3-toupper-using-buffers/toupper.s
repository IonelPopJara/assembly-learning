    ...
    #           never exceed 16,000 for vairous
    #           reasons.
    .equ BUFFER_SIZE, 250
    .lcomm BUFFER_DATA, BUFFER_SIZE

    # Create buffers for the file descriptors
    .lcomm BF_FD_IN, 1024
    .lcomm BF_FD_OUT, 1024
...
read_loop_begin:
    ...
    # The $ means that we move the address
    movl $BUFFER_DATA, %ecx
    # the size o the buffer
